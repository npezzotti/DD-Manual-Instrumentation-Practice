...
var Config = function Config(options) {
  ...
  var service = options.service || platform.env('DD_SERVICE') || platform.env('DD_SERVICE_NAME') || tags.service || platform.service() || 'node';
  var version = coalesce(options.version, platform.env('DD_VERSION'), tags.version, platform.appVersion());
  var env = coalesce(options.env, platform.env('DD_ENV'), tags.env);
  tagger.add(tags, {
    service: service,
    env: env,
    version: version
